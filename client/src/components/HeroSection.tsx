      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-foreground/70 leading-relaxed font-semibold">
              We handle the licensing. You handle the leads.
            </p>
            <p className="text-lg text-foreground/60 leading-relaxed">
              From trade licenses and banking to high-converting web design, Inceptum provides the operational <span className="font-semibold text-purple-700">"Roots"</span> and digital <span className="font-semibold text-cyan-700">"Growth"</span> your business needs to thrive in 30 days or less.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 pt-8">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">To Launch</p>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center justify-center">
          <div className="relative w-full h-96">
            ...
            <div className="absolute inset-8 bg-white/5 backdrop-blur-xl rounded-xl border border-white/20 flex flex-col items-center justify-center p-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-foreground/60 text-sm">
                  Operational infrastructure + Digital excellence
                </p>
              </div>
            </div>
          </div>
